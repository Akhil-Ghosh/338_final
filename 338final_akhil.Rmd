...
new_tr <- model.matrix(~.+0,data = train.data[,-c("rain_tomorrow"),with=F]) 

labels <- as.numeric(train.data$rain_tomorrow )

new_ts <- model.matrix(~.+0,data = test.data[,-c("rain_tomorrow"),with=F])
